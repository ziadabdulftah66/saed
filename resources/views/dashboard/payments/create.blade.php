                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href=""> الدفعات  </a>
                                </li>
                                <li class="breadcrumb-item active"> أضافه دفعه
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> أضافة دفعه </h4>
                                                        ...
                                                        <form action="{{ route('admin.payments.store') }}" method="post" class="form">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="date" name="payment_date" class="form-control pickdate">
                                                            ...
                                                            <div class="col-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" name="payment_price" class="form-control pickdate">
